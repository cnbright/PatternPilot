...
运行已发布的小体积单文件版（`single-small`）时，需要先安装 .NET 8 Windows Desktop Runtime（x64）：

- 官方下载页（.NET 8 Desktop Runtime，含 Windows x64 安装项）：https://dotnet.microsoft.com/zh-cn/download/dotnet/8.0
- 如需本地编译，则安装 .NET 8 SDK：https://dotnet.microsoft.com/zh-cn/download/dotnet/8.0
